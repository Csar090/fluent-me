const CACHE='fluency-os-v2.6.0';
const FILES=['./','index.html','styles.css','app.js','enhancements.js','cloud.js','config.js','fluency-v23.js','fluency-v23.css','saved-reviews.js','secure-storage.js','manifest.webmanifest'];
